    ...
    <div class="container mx-auto bg-none py-24">
        <div class="rounded-xl w-full p-6 bg-white shadow-md">
            <div class="w-full flex justify-between py-3 pb-10 px-14">
                ...
                <div class="flex flex-wrap items-center bg-gray-100 justify-between w-72 rounded-2xl overflow-hidden px-3 py-1">
                  <input v-model="search" class="bg-gray-100 w-60 outline-none" type="text">
                  <i class="fa-solid fa-magnifying-glass"></i>
                </div>
            </div>
            <div class="w-full flex gap-4 flex-wrap justify-center" v-if="products != []">
                <TransitionGroup name="allPro" mode="in-out">
                  <div class="w-72 h-96 overflow-hidden rounded-xl flex flex-wrap" v-for="(product, index) in searchFilters">
                    <div>
